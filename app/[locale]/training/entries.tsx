  ...
  vi: [
    {
      ...
      content: (
        <>
          <p>
            Hôm nay mình bắt đầu tìm hiểu về Software Testing. Đây là những
            ghi chú đầu tiên của mình.
          </p>

          <h4>Software Testing là gì?</h4>
          <p>
            Software Testing (Kiểm thử phần mềm) là quá trình đánh giá và xác
            minh rằng một sản phẩm phần mềm hoạt động đúng như mong đợi.
          </p>

          <h4>Các loại testing cơ bản:</h4>
          <ul>
            <li>
              <strong>Manual Testing</strong> - Kiểm thử thủ công, người tester
              tự thực hiện các test case
            </li>
            <li>
            ...
            <li>
              <strong>Unit Testing</strong> - Kiểm thử từng đơn vị nhỏ nhất của
              code
            </li>
            <li>
              <strong>Integration Testing</strong> - Kiểm thử sự tương tác giữa
              các module
            </li>
          </ul>
      ...
      content: (
        <>
          ...
          <ul>
            ...
            <li>
              <strong>Automation Testing</strong> - Using tools/scripts to
